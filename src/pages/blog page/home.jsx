...
const BlogHomepage = ({ featuredPost, data }) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-16">
            ...
            <div className="overflow-hidden rounded-xl">
              ...
              >
                <div ref={scrollContainerRef} className="flex flex-row flex-nowrap gap-6 overflow-x-auto w-full scrollbar-hide scroll-smooth scrollbar-thumb-slate-200 scrollbar-track-stone-400 scrollbar ">
                  {data?.map((post, index) => (
          ...
          <section className="mb-16">
            ...
            <div className="overflow-hidden">
              ...
              >
                <div className="grid sm:grid-cols-2 lg:grid-cols-3  gap-6  min-w-full">
