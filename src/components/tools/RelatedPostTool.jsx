...
class RelatedPostTool {
    ...
    save(blockContent) {
      const title = blockContent.querySelector('.ce-related-post__title').value;
      const url = blockContent.querySelector('.ce-related-post__url').value;
      const description = blockContent.querySelector('.ce-related-post__description').value;
  ...
  export default RelatedPostTool;